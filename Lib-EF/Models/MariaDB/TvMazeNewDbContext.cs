...
public partial class TvMazeNewDbContext : DbContext
{
    public TvMazeNewDbContext()
    {
    }

    public TvMazeNewDbContext(DbContextOptions<TvMazeNewDbContext> options)
        : base(options)
    {
    }
    ...
    {
        var appInfo = new AppInfo("PlexMediaControl", "TvMazeDbContext", "TvMazeDbContext");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Showepisodecount>(entity =>
        {
            ...
            entity.Property(e => e.EpisodeCount).HasColumnType("int(11)");
